namespace AeroSharp.Connection
{
    ...
    public interface IConnectionBuilderNeedingContext
    {
        ...
        /// A connection object containing information needed to establish a connection to
        /// Aerospike.
        /// </param>
        /// <returns>An instance of the next builder.</returns>
    ...
    public interface IConnectionBuilder
    {
        ...
        /// <summary>
        /// Optional. Use the provided <see cref="ConnectionConfiguration" />. If no configuration is specified (i.e. this is never
        /// called) a default configuration will be used.
        /// </summary>
