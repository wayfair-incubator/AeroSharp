...
namespace AeroSharp.DataAccess
{
    ...
    public class WriteConfiguration
    {
        ...
        /// The default (COMMIT_ALL) indicates that the server should wait for master and all replica commits to be successful before returning success to the client.
        /// </summary>
        ...
        /// <summary>
        /// If the transaction results in a record deletion, leave a tombstone for the record. This prevents deleted records from reappearing after node failures.
        /// </summary>
        ...
        /// If a write operation is creating a record, the expected generation would be 0. This field is only relevant when generationPolicy is not NONE.
        /// </summary>
        ...
        /// <summary>
        /// Socket idle timeout in milliseconds when processing a database command. If socketTimeout is zero and totalTimeout is non-zero,
        /// then socketTimeout will be set to totalTimeout.If both socketTimeout and totalTimeout are non-zero and socketTimeout > totalTimeout,
        /// then socketTimeout will be set to totalTimeout.If both socketTimeout and totalTimeout are zero, then there will be no socket idle limit.
        /// If socketTimeout is not zero and the socket has been idle for at least socketTimeout, both maxRetries and totalTimeout are checked.
