...
namespace AeroSharp.DataAccess.General
{
    ...
    public interface ISetScannerBuilder : ICompressorBuilder<ISetScannerBuilder>
    {
        ...
        ISetScanner Build();
        /// <summary>
        /// Builds a <see cref="ISetScanner{T}"/> to scan any set reading from the default first bin whose type is <typeparamref name="T"/>.
        /// </summary>
        ...
        /// <summary>
        /// Builds a <see cref="ISetScanner{T}"/> to scan any set reading from the specified bin whose type is <typeparamref name="T"/>.
        /// </summary>
        ...
        /// <summary>
        /// Builds a <see cref="ISetScanner{T1,T2}"/> to scan any set reading from the default first two bins whose types are <typeparamref name="T1"/> and <typeparamref name="T2"/> respectively.
        /// </summary>
        ...
        /// <summary>
        /// Builds a <see cref="ISetScanner{T1,T2}"/> to scan any set reading from the specified bins whose types are <typeparamref name="T1"/> and <typeparamref name="T2"/> respectively.
        /// </summary>
        ...
        /// <summary>
        /// Builds a <see cref="ISetScanner{T1,T2,T3}"/> to scan any set reading from the default first three bins whose types are <typeparamref name="T1"/>, <typeparamref name="T2"/>, and <typeparamref name="T3"/> respectively.
        /// </summary>
        /// <typeparam name="T1">The type of the value in the first default bin.</typeparam>
        /// <typeparam name="T2">The type of the value in the second default bin.</typeparam>
        ...
        /// <summary>
        /// Builds a <see cref="ISetScanner{T1,T2,T3}"/> to scan any set reading from the specified bins whose types are <typeparamref name="T1"/>, <typeparamref name="T2"/>, and <typeparamref name="T3"/> respectively.
        /// </summary>
