...
{
    /// <summary>
    /// An interface for quickly truncating all records contained in a namespace/set. It gets the namespace and set from the
    /// <see cref="DataContext" /> passed into the <see cref="SetTruncatorBuilder" />.
