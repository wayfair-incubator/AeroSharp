...
namespace AeroSharp.DataAccess.Internal
{
    ...
    internal static class MapOperations
    {
        ...
        {
            return MapOperation.GetByKey(bin, mapEntryGenerator.GenerateKey(key), MapReturnType.KEY_VALUE);
        }
        ...
        {
            return MapOperation.RemoveByKey(bin, mapEntryGenerator.GenerateKey(key), MapReturnType.KEY_VALUE);
        }
    }
}